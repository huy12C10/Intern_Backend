...
var DebtService = /** @class */ (function () {
    ...
    DebtService.prototype.findAll = function (query) {
        return __awaiter(this, void 0, Promise, function () {
            var filters, searchKeyword, debtsQuery;
            return __generator(this, function (_a) {
                filters = {};
                if (query.amount) {
                ...
                debtsQuery = this.debtModel.find(__assign(__assign({}, filters), searchKeyword));

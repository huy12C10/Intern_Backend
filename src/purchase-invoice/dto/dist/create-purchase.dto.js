...
var CreatePurchaseDto = /** @class */ (function () {
    ...
    ], CreatePurchaseDto.prototype, "supplierId");
    __decorate([
        class_validator_1.IsNotEmpty(),
        class_validator_1.IsObject()
    ], CreatePurchaseDto.prototype, "purchaseProducts");
    __decorate([
        class_validator_1.IsNotEmpty(),
        class_validator_1.IsEnum(purchase_invoice_schema_1.StatusPurchaseInvoice)
    ], CreatePurchaseDto.prototype, "statusPurchaseInvoice");
    __decorate([
        class_validator_1.IsNotEmpty(),
        class_validator_1.IsString()
    ], CreatePurchaseDto.prototype, "adminId");
    __decorate([
        class_validator_1.IsNotEmpty(),
        class_validator_1.IsNumber()
    ], CreatePurchaseDto.prototype, "sumBill");
    __decorate([
        class_validator_1.IsNotEmpty(),
        class_validator_1.IsDateString()
    ], CreatePurchaseDto.prototype, "createdAt");
    __decorate([
        class_validator_1.IsNotEmpty(),
        class_validator_1.IsString()
    ], CreatePurchaseDto.prototype, "supplier");
